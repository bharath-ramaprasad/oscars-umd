...
-- add one dummy user to the users table Should be removed before production use
...
-- grant our dummy user attribute of OSCARS-engineer
...
-- grant our dummy user attribute of OSCARS-service so that it can be used for forward inter-domain reservations
INSERT IGNORE INTO userAttributes VALUES (null,
                                         (select id from users where login="client"),
