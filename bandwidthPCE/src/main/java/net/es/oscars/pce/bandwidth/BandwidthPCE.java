...
public class BandwidthPCE {
        ...
        */
		...
		/*************************************************************
			...
			Comment:	The reqElemMap contains data concerning the
						destintion.  Our implementation loops for
						destination in order to build a map which 
    ...
    private boolean validateGranularity(String granularity, int reqBandwidth){
        ...
        try{
            double granDoub = Double.parseDouble(granularity)/MBPS_DENOM;
            if((reqBandwidth % granDoub) != 0){
                return false;
            }
        }catch(Exception e){}
