...
public class ListReservationRequest extends CoordRequest <ListRequest, ListReply>{
     ...
     * @param  were set in the constructor: authDecision, listRequest
     * @return ListReply set in this.ResultData.
     */
    public void execute() {
        ...
        try {
            ...
            this.fail2 (new OSCARSServiceException(method +" caught exception "+ ex.getMessage(), ex.getType()));
