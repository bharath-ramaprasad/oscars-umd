...
public class QueryReservationRequest extends CoordRequest <QueryResContent, QueryResReply> {
     ...
     * @param authDecision  results of the checkAuthorization call for this user and action
     * @param griReq GlobalReservationId of the reservation to be queried
     */
     ...
     * @param  were set in the constructor: authDecision, QueryResContent
    ...
    public void execute(){
        ...
        try {
            ...
            this.fail2(new OSCARSServiceException(message, "system"));
