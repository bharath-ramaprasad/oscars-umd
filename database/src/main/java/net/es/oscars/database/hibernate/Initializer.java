...
public class Initializer {
     ...
     */
    public void initDatabase(List<String> dbnames, String username,
                             String password, String monitor, String serviceName) {
        // initializes session factories for given databases
        HibernateUtil.initSessionFactories(dbnames, username, password,
                                           monitor, serviceName);
    }
}
