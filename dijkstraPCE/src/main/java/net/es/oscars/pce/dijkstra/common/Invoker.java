package net.es.oscars.pce.dijkstra.common;

import static java.util.Arrays.asList;

import net.es.oscars.logging.OSCARSNetLogger;
import net.es.oscars.pce.dijkstra.DijkstraPCEServer;
...
public class Invoker {
    ...
    /**
     * Main program to start DijkstraPCE 
    ...
    public static void main(String[] args) throws Exception {
        ...
        parseArgs( args );
        System.out.println("starting dijkstraPCE service with context " + context);
        cc.setContext(context);
        cc.setServiceName(ServiceNames.SVC_PCE_DIJ);
        try {
        ...
        DijkstraPCEServer server = new DijkstraPCEServer();
        server.startServer(false);
        log.info(netLogger.end("invoker","dijkstra PCE server has started with context: " + context));
