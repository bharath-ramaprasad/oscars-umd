        ...
        OptionParser parser = new OptionParser(){
            {
                ...
                acceptsAll(Arrays.asList("reg-publishto", "p"), "(reg-add*, reg-mod) the URL of the perfSONAR LS where this registration exists").withRequiredArg().ofType(String.class);
