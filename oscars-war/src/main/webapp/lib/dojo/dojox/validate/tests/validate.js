	...
	[{
		...
		setUp: function(){
			...
			for(var i = 0 ; i < localeList.length; i ++){
				dojo.requireLocalization("dojo.cldr", "currency", localeList[i], "zh,en-ca,pt,en-us,de,ja,en,en-au,ROOT,fr,es,ko,zh-tw,it");
				dojo.requireLocalization("dojo.cldr", "number", localeList[i], "zh-cn,zh,ko-kr,pt,en-us,en-gb,de,ja,ja-jp,en,ROOT,en-au,fr,es,ko,zh-tw,it,es-es,de-de");
			}
		},
