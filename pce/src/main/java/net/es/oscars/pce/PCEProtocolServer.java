...
public class PCEProtocolServer extends OSCARSSoapService  <PCEService, PCEPortType> {
    ...
    private PCERuntimeClient pceRuntimeClient = null;
    private ContextConfig cc = ContextConfig.getInstance();
    
    public PCEProtocolServer() throws OSCARSServiceException {
        super();
    }
