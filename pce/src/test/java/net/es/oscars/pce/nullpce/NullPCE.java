...
public class NullPCE extends PCEProtocolServer implements Runnable {
    ...
    private void processQuery (PCEMessage query) throws OSCARSServiceException {
        ...
        try {
            ...
            if (query.getMethod().equals("pceCreate")) {
                ...
                client.sendCommitReply(query.getMessageProperties(),query.getGri(), query.getTransactionId(), query.getPceName(), pceDataContent);
            }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            cc.setServiceName(ServiceNames.SVC_PCE);
            try {
