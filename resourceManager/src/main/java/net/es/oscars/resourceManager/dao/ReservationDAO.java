...
public class ReservationDAO
    ...
    public Reservation query(String gri)
        ...
        if (reservation == null) {
            throw new RMException ("No reservation matches requested gri: " + gri);
        }
        return reservation;
    }
    ...
    public void update(Reservation reservation) {
        ...
        try {
            ...
            stateEngine.updateStatus(reservation, null);
    ...
    public List<Reservation> pendingReservations(int timeInterval) {
        ...
        lookAhead = curTime + timeInterval;
     ...
     * during the specified time interval and are still in reserved or active states
     *
     ...
     */
    @SuppressWarnings("unchecked")
    public List<Reservation> unfinishedExpiredReservations(int timeInterval) {

        this.reservations = null;
        long seconds = System.currentTimeMillis()/1000 + timeInterval;
