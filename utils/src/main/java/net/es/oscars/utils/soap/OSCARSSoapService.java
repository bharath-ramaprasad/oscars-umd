...
public class OSCARSSoapService <S,P> {
     ...
     */
    @SuppressWarnings("unchecked")
    private void configurePublishedPaths() throws OSCARSServiceException {
    ...
    public Object[] invoke (String operation, Object[] params) throws OSCARSServiceException {
        ...
        try {
            ...
            return res;
        } catch (OSCARSFaultMessage ex) {
            LOG.warn(netLogger.error(event,ErrSev.MAJOR,"catching OSCARSFaultMessage " + ex.getMessage() + " " +
                    ex.getFaultInfo().getDetails()));
            ...
            LOG.warn(netLogger.error(event, ErrSev.MAJOR,newMessage));
            throw new OSCARSServiceException(newMessage,"system");
        }
